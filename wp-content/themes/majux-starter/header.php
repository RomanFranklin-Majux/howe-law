...
<header id="main" class="d-flex align-items-center">
	<div class="container-fluid ">
		...
		<div class="row navigation-main-menu pe-0 d-none d-lg-flex justify-content-end align-items-center">
		...
		<div class="row d-md-none px-3">
			<div class="col d-flex flex-column px-0">
				<a href="tel:<?php echo phoneNumber(); ?>" class="btn btn-primary">Get In Touch</a>
				<a href="sms:<?php echo phoneNumber('phone_number_2'); ?>" class="btn btn-secondary">How We Can Help</a>
			</div>
		</div>
	</div>	
</header>
